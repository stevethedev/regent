...
class BaseObject {
     ...
     * @method mix
     *
     * @param {...Object} mixins - Objects to mixin to class instances
     *
     * @return {this}
     */
    static mix(...mixins) {
     ...
     * @method staticMix
     *
     * @param {...Object} mixins - Objects to mixin to the class statics
     *
     * @return {this}
     */
    static staticMix(...mixins) {
     ...
     *
     * Note that this replaces any existing methods on the class, and it does
     * not provide access to $private variables. Use at your own risk.
     *
     * @method extend
     *
     * @param {String}   declaration - The name of the function to attach
     * @param {Function} definition  - The function to attach
     *
     * @return {this}
     */
    static extend(declaration, definition) {
        this.prototype[declaration] = definition;
        return this;
    }
