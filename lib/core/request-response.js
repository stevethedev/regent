...
const Session        = require('regent/lib/http/session/session');
const SessionManager = require('regent/lib/http/session/manager');
const CookieManager  = require('regent/lib/http/cookie/manager');
