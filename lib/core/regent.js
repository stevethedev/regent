...
class Regent extends BaseObject
{
    ...
    getTemplater()
    {
        return _private(this).templateManager;
    }
}
...
function registerTemplateMgr(sysConfig, appConfig)
{
    ...
    let templateOptions = {};
    if (appConfig && appConfig.templateOptions) {
        templateOptions = appConfig.templateOptions;
    }

    _private(this).templateManager = new TemplateManager(this, templateOptions);
}
