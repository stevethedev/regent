...
const QueryBuilder      = require('regent/lib/db/relational/base/query-builder');

const sqlAggregateMixin = require('regent/lib/db/relational/mixins/sql-aggregate');
const sqlDistinctMixin  = require('regent/lib/db/relational/mixins/sql-distinct');
...
const sqlIncrementMixin = require('regent/lib/db/relational/mixins/sql-increment');
