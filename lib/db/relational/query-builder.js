...
class QueryBuilder extends BaseQueryBuilder
{
    ...
    where(field, operator = '=', value = undefined)
    {
        ...
        self.parts.get(PART_WHERE).push({ field, operator, value });
        return this;
    }
    ...
    orWhere(field, operator = '=', value = undefined)
    {
        ...
        self.parts.get(PART_WHERE).push({ field, operator, value, joiner });
        return this;
    }
    ...
    orWhereRaw(signature, values = [])
    {
        const self = _protected(this);
        const joiner = 'OR';
        self.parts.get(PART_WHERE).push({ signature, values, joiner });
        return this;
    }
}
