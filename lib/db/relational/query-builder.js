...
class QueryBuilder extends BaseQueryBuilder {
     ...
     */
    whereDay(field, ...args) {
        const dateFn    = (date) => date.getDate();
        const dialectFn = 'dateDay';
        const join      = 'AND';
        return this.call(
            whereDateGeneric,
            {
    ...
    whereMonth(field, ...args) {
        const dateFn    = (date) => 1 + date.getMonth();
        const dialectFn = 'dateMonth';
        const join      = 'AND';
        return this.call(
            whereDateGeneric,
            {
    ...
    whereYear(field, ...args) {
        const dateFn    = (date) => date.getFullYear();
        const dialectFn = 'dateYear';
        const join      = 'AND';
        return this.call(
            whereDateGeneric,
            {
 ...
 *
 * @param {String}  options.join      - AND/OR
