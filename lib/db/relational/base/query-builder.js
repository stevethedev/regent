...
const BaseDialect      = require('regent/lib/db/relational/dialect');
const BaseQueryBuilder = require('regent/lib/db/query-builder');
const ObjectMerger     = require('regent/lib/util/object-merger');
const Record           = require('regent/lib/db/relational/record');
...
const {
    ...
    PART_TABLE,
    PART_TABLE_ALIAS,
} = require('regent/lib/db/relational/parts');
...
class QueryBuilder extends BaseQueryBuilder {
    ...
    tuplesToRecords(tuples) {
        ...
        return new RegentCollection(tuples.map((tuple) => {
            const index = {
