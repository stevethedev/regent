...
class RegentSet extends BaseCollection {
    constructor(source = []) {
        super();
        ...
        source.forEach((value) => internal.add(value));
    }
    ...
    /**
     * Create a Collection from the Set
     *
     * @method toCollection
     *
     * @return {RegentCollection}
     */
    toCollection() {
        return RegentCollection.create(this.toArray());
    }

    /**
     * Get an iterator to step through the entries
     *
     * @method entries
     *
     ...
     */
    * entries() {
        yield* $protected(this).internal.values();
    }
}
