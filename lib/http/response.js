...
class HttpResponse extends RequestResponse
{
    ...
    async send(statusCode = _protected(this).httpStatusCode)
    {
        ...
        this.getRegent().getEmitter().emit(Events.HTTP_AFTER_RESPONSE, this);
        return response;
    }
     ...
     * @chainable
     */
    async stream(filePath, statusCode = _protected(this).httpStatusCode)
    {
        ...
        await fileSystem.readStream(filePath, _protected(this).httpResponse);
...
{
    let cookies = _protected(this).cookies.getIterator();
