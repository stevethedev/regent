...
class HttpResponse extends RegentObject
{
    ...
    constructor(httpKernel, httpResponse)
    {
         ...
         * @property {HttpKernel}
         */
        _protected(this).httpKernel = httpKernel;

        /**
         * @protected
         * @property {http.ServerResponse}
         */
        _protected(this).httpResponse = httpResponse;
         ...
         * @property {Number}
         */
        _protected(this).httpStatusCode = 200;
    ...
    {
        _protected(this).httpResponse.setHeader(headerName, headerValue);
        return this;
    }
    ...
    {
        _protected(this).httpResponse.removeHeader(headerName);
        return this;
    }
    ...
    {
        if (headerDictionary && 'object' == typeof _protected(this).httpStatusCode) {
    ...
    {
        return _protected(this).httpResponse.hasHeader(headerName);
    }
    ...
    appendBody(...content)
    {
        ...
        _protected(this).responseBody = _protected(this).responseBody + content.join('');
        return this;
    }
    ...
    {
        content = sanitize(content);
        _protected(this).responseBody = content.join('') + _protected(this).responseBody;
        return this;
    }
    ...
    {
        content = sanitize(content);
        _protected(this).responseBody = '' + content.join('');
        return this;
    }
    ...
    {
        _protected(this).httpStatusCode = statusCode;
        return this;
    }
    ...
    send(statusCode = _protected(this).httpStatusCode)
    {
        const callback = (resolve, reject) => {
            _protected(this).httpStatusCode = statusCode;
            _protected(this).httpResponse.writeHead(statusCode);
            _protected(this).httpResponse.end(_protected(this).responseBody, (err) => {
                if (err) {
                    return reject(err);
                }
                _protected(this).isSent = true;
                return resolve();
            });
        };
    ...
    isSent()
    {
        return _protected(this).isSent;
    }

    async render(template, options)
    {
        const content = await this.getRegent().getTemplater().render(template, options);
